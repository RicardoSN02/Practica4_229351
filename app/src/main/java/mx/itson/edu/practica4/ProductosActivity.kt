...
class ProductosActivity : AppCompatActivity() {
    ...
    fun agregarProductos(menuOption: String?){
        var imgA: ImageView =findViewById(R.id.imageViewTitulo) as ImageView
        when(menuOption){
            "Antojitos" ->{
            ...
            "Especialidades" ->{
                ...
                menu.add(Product("Fajita Burrito",R.drawable.fajitaquesadilla,"Gran burrito relleno de tu carne favorita, cebolla, chile, arroz, frijoles y jitomate. Servido con lechuga y guacamole Large burrito filled with your choice of meat, onions, chile, peppers, rice, beans and tomatoes. Served with lettuce guacamole and sour cream.",12.99))
            ...
            "Tortas" ->{
                ...
                menu.add(Product("Torta Milanesa de res o de pollo",R.drawable.tortamilanesa,"Breaded Steak or Chicken",12.99))
            ...
            "Drinks" ->{
                ...
                menu.add(Product("Aguas Frescas",R.drawable.imagen1,"",2.99))
                ...
                menu.add(Product("La mamalona",R.drawable.michelada,"(michelada 2 Cervesas)",12.99))
